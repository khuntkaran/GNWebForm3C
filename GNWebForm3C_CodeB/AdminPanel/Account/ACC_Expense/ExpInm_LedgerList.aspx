<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="ExpInm_LedgerList.aspx.cs" Inherits="AdminPanel_Account_ACC_Expense_ExpInm_LedgerList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Ladger"></asp:Label>
    <small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Ladger"></asp:Label>
    </li>
</asp:Content>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <div class="row" style="content:'';" runat="server" id="Div_SearchResult" visible="false">
                                <div class="col-12">
                                    <div id="TableContent">
                                        <table class="table  table-bordered table-advanced table-striped " id="sample_1">
                                            <%-- Table Header --%>
                                            <thead>
                                                <tr class="TRDark row" style="content:'';">
                                                    <th class="text-center col-md-3">
                                                        <asp:Label ID="lbhLedgerDate" runat="server" Text="Date"></asp:Label>
                                                    </th>
                                                    <th class="text-center col-md-3">
                                                        <asp:Label ID="lbhLedgerType" runat="server" Text="Type (Income/Expense)"></asp:Label>
                                                    </th>
                                                    <th class="text-right col-md-3">
                                                        <asp:Label ID="lbhLedgerAmount" runat="server" Text="Amount"></asp:Label>
                                                    </th>
                                                    <th class="col-md-3">
                                                        <asp:Label ID="lbhLedgerNote" runat="server" Text="Note"></asp:Label>
                                                    </th>
                                                ...
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="row" style=' content:"";<%# Eval("LedgerType").ToString() == "Income" ? "background-color: green; color: white;": "background-color: red; color: white;" %>'>
                                                            ...
                                                            <td class="text-center col-md-3">
                                                                <%#Eval("LedgerType",GNForm3C.CV.DefaultCurrencyFormatWithDecimalPoint) %>
                                                            </td>
                                                            <td class="text-right col-md-3">
                                                                <%#Eval("LedgerAmount",GNForm3C.CV.DefaultCurrencyFormatWithDecimalPoint) %>
                                                            </td>
                                                            <td class="col-md-3">
                                                                <%#Eval("LedgerNote",GNForm3C.CV.DefaultCurrencyFormatWithDecimalPoint) %>
                                                            </td>
