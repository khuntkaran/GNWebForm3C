<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="EMP_EmployeeDetailList.aspx.cs" Inherits="AdminPanel_Employee_EMP_EmployeeDetail_EMP_EmployeeDetailList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Employee Detail"></asp:Label>
    <small>
        <asp:Label ID="lblPageHeaderInfo_XXXXX" runat="server" Text="Employee"></asp:Label></small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="Employee Detail"></asp:Label>
    </li>
</asp:Content>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox CssClass="First form-control" PlaceHolder="Search"  ID="txtAutoComplete" runat="server"></asp:TextBox>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddMore" ID="hlAddManyMore" NavigateUrl="~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailAddEditMore.aspx" runat="server"></asp:HyperLink>
                                    <asp:HyperLink SkinID="hlAddMany" ID="hlAddMany" NavigateUrl="~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailAddEditMany.aspx" runat="server"></asp:HyperLink>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailAddEdit.aspx" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="lbhEmployeeType" runat="server" Text="Employee Type"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewExpenseTypeID" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("EmployeeName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("EmployeeTypeName") %>
                                                            </td>
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailView.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Employee/EMP_EmployeeDetail/EMP_EmployeeDetailAddEdit.aspx?EmployeeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("EmployeeID").ToString()) %>' runat="server"></asp:HyperLink>
