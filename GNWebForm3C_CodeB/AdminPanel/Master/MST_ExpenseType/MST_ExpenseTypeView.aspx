<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default/MasterPageView.master" CodeFile="MST_ExpenseTypeView.aspx.cs" Inherits="AdminPanel_Master_MST_ExpenseType_MST_ExpenseTypeView" Title="Expense Type View"%>
	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">Expense Type</span>
			</div>
			<div class="tools">
		...
		<table class="table table-bordered table-advance table-hover">
			<tr>
				<td class="TDDarkView">
				<asp:Label ID="lblExpenseType_XXXXX" Text="Expense Type" runat="server"></asp:Label>
				</td>
				<td>
