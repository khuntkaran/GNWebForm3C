<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="STU_StudentList.aspx.cs" Inherits="AdminPanel_Student_STU_Student_STU_StudentList" %>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEnrollmentNo" CssClass="First form-control" runat="server" PlaceHolder="Enter Enrollment No"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEmailInstitute" CssClass="First form-control" runat="server" PlaceHolder="Enter Email Institute"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEmailPersonal" CssClass="First form-control" runat="server" PlaceHolder="Enter Email Personal"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtRollNo" CssClass="First form-control" onkeypress="return IsPositiveInteger(event)" runat="server" PlaceHolder="Enter Roll No"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtContactNo" CssClass="First form-control" runat="server" PlaceHolder="Enter Contact No"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="View" ID="HyperLink2" NavigateUrl="~/AdminPanel/Student/STU_Student/STU_StudentAddEditPopUp.aspx"  data-target="#view" data-toggle="modal" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="lbhEmailInstitute" runat="server" Text="Email Institute"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhEmailPersonal" runat="server" Text="Email Personal"></asp:Label>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewStudentID" NavigateUrl='<%# "~/AdminPanel/Student/STU_Student/STU_StudentView.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("StudentName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("EnrollmentNo") %>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="HyperLink1" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Student/STU_Student/STU_StudentAddEditPopUp.aspx?StudentID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("StudentID").ToString()) %>' data-target="#view" data-toggle="modal" runat="server"></asp:HyperLink>
