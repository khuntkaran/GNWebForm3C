<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_ExpenseTypeList.aspx.cs" Inherits="AdminPanel_MST_ExpenseType_MST_ExpenseTypeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Expense Type"></asp:Label>
    <small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtExpenseType" CssClass="First form-control" runat="server" PlaceHolder="Enter Expense Type"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddMore" ID="hlAddManyMore" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEditMore.aspx" runat="server"></asp:HyperLink>
                                    <asp:HyperLink SkinID="hlAddMany" ID="hlAddMany" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEditMany.aspx" runat="server"></asp:HyperLink>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEdit.aspx" runat="server"></asp:HyperLink>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewExpenseTypeID" NavigateUrl='<%# "~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeView.aspx?ExpenseTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ExpenseTypeID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("ExpenseType") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <%#Eval("Hospital") %>
                                                            </td>
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeView.aspx?ExpenseTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ExpenseTypeID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Master/MST_ExpenseType/MST_ExpenseTypeAddEdit.aspx?ExpenseTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ExpenseTypeID").ToString()) %>' runat="server"></asp:HyperLink>
