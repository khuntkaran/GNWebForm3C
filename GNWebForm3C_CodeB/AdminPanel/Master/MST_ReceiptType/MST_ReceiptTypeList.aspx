                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlIsDefault" CssClass="form-control select2me" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhReceiptTypeName" runat="server" Text="Receipt Type Name"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhPrintName" runat="server" Text="Print Name"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhIsDefault" runat="server" Text="Is Default"></asp:Label>
                                                    </th>
                                                    <th>
