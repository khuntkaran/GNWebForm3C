                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                ...
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Account/ACC_GNTransaction/ACC_GNTransactionAddEdit.aspx?HospitalID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("HospitalID").ToString()) +"&PatientID="+GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString())+"&FinYearID="+GNForm3C.CommonFunctions.EncryptBase64(Eval("FinYearID").ToString()) %>' runat="server" Enabled='<%# Eval("DateOfDischarge") == DBNull.Value ? true : false %>'></asp:HyperLink>
